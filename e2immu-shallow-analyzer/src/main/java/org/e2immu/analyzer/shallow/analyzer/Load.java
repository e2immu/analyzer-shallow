...
public class Load {
    ...
    public void go(List<String> classPath) throws IOException {
    ...
    public void go(JavaInspector javaInspector) throws IOException {
        Codec.DecoderProvider decoderProvider = ValueImpl::decoder;
        Codec codec = new CodecImpl(decoderProvider, fqn -> javaInspector.compiledTypesManager().getOrLoad(fqn));
